...
from models import RiskAssessmentReport, FinancialProfile
from db import db
from routes import blp as risk_blueprint
...
def create_app(db_url=None):
    ...
    api.register_blueprint(risk_blueprint, url_prefix="/api/risk")
    return app
